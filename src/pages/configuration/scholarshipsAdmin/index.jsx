...
import DetailScholarshipsModal from "./detailScholarshipsModal";
...
export const ScholarshipsAdmin = () => {
  ...
  const fetchData = async () => {
    const res = await postPublic(`/scholarship/getScholarship`, {
      page: pageNumber,
      size: itemsPerPage,
    });
  ...
  const handleDelete = async (n) => {
    Alert.confirm(
      ...
      async () => {
        const res = await deletePrivate(`/scholarship/delete/${n.id}`);
